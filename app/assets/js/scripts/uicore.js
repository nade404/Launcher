...
remote.getCurrentWebContents().on('devtools-opened', () => {
    console.log('%cLa console est sombre', 'color: white; -webkit-text-stroke: 4px #a02d2a; font-size: 60px; font-weight: bold')
    console.log('%cÉcrivez quelque chose ici que si vous savez exactement ce que vous faites!', 'font-size: 16px')
    console.log('%cVous pouvez faire beaucoup de dégâts avec ça!', 'font-size: 16px')
})
    ...
    ipcRenderer.on('autoUpdateNotification', (event, arg, info) => {
        switch(arg){
            ...
            case 'update-downloaded':
                loggerAutoUpdaterSuccess.log('Update ' + info.version + ' prêt à être installé')
                settingsUpdateButtonStatus('Installer la mise à jour maintenant!', false, () => {
                    if(!isDev){
